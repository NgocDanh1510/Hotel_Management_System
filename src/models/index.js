...
Hotel.hasMany(Image, { foreignKey: 'entity_id', constraints: false, scope: { entity_type: 'hotel' } });

// RoomType
RoomType.belongsTo(Hotel, { foreignKey: 'hotel_id' });
RoomType.hasMany(Room, { foreignKey: 'room_type_id' });
RoomType.belongsToMany(Amenity, { through: RoomTypeAmenity, foreignKey: 'room_type_id' });
RoomType.hasMany(Image, { foreignKey: 'entity_id', constraints: false, scope: { entity_type: 'room_type' } });
